...
linked-record reliability---proxied by inconsistencies in reported age
progressions or education levels---we find that the baseline misclassification
rate is approximately 2.3\% for reliable records but rises to about 18\%
for waves with an implausible age progression. This evidence is consistent with
both response error and incorrect panel matches; it does not attempt to separate
the two sources of employment-status misclassification.
