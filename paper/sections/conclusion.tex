...
structural corroboration using job tenure data. Linked records with inconsistent
age or education progressions exhibit employment dynamics consistent with much
higher misclassification rates. This mechanism evidence encompasses both
incorrect responses and incorrect panel matches and does not privilege either
