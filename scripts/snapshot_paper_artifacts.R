...
table_files <- c(
  ...
  "EM-baseline/output/tables/table_matching_composition.tex",
  "EM-baseline/output/tables/table_matching_standardized.tex",
...
result_files <- c(
  ...
  "EM-baseline/output/results/matching_composition_summary.csv",
  "EM-baseline/output/results/matching_standardized_margins.csv",
  "EM-baseline/output/results/matching_composition_decomposition.csv",
  "EM-baseline/output/results/matching_pooled_group_margins.csv",
