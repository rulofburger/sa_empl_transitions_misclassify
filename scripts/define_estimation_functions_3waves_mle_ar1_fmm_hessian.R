...
calc_hessian_3waves_ar1_fmm2 <- function(param_transformed, pi0 = FALSE) {
  ...
  df_hessian_temp1 <- df_probs_temp1 %>% 
    ...
    summarise(
      joint_d_theta0_1 = sum(joint_d_theta0_1),
      joint_d_theta1_1 = sum(joint_d_theta1_1),
      joint_d_pi_1 = sum(joint_d_pi),
      joint_d2_theta0_1_theta0_1 = sum(joint_d2_theta0_1_theta0_1),
      joint_d2_theta1_1_theta1_1 = sum(joint_d2_theta1_1_theta1_1),
      joint_d2_pi_pi_1 = sum(joint_d2_pi_pi),
      joint_d2_theta0_1_theta1_1 = sum(joint_d2_theta0_1_theta1_1),
      joint_d2_theta0_1_pi = sum(joint_d2_theta0_1_pi),
      joint_d2_theta1_1_pi = sum(joint_d2_theta1_1_pi),
      joint_p1 = sum(joint_p),
      .groups = "drop"
    )
  ...
  df_hessian_temp2 <- df_probs_temp2 %>% 
    ...
    summarise(
      joint_d_theta0_2 = sum(joint_d_theta0_2),
      joint_d_theta1_2 = sum(joint_d_theta1_2),
      joint_d_pi_2 = sum(joint_d_pi),
      joint_d2_theta0_2_theta0_2 = sum(joint_d2_theta0_2_theta0_2),
      joint_d2_theta1_2_theta1_2 = sum(joint_d2_theta1_2_theta1_2),
      joint_d2_pi_pi_2 = sum(joint_d2_pi_pi),
      joint_d2_theta0_2_theta1_2 = sum(joint_d2_theta0_2_theta1_2),
      joint_d2_theta0_2_pi = sum(joint_d2_theta0_2_pi),
      joint_d2_theta1_2_pi = sum(joint_d2_theta1_2_pi),
      joint_p2 = sum(joint_p),
      .groups = "drop"
    )
  
  df_hessian_temp <- df_hessian_temp1 %>% 
    left_join(df_hessian_temp2, by = c('y1', 'y2', 'y3')) %>% 
    mutate(
  ...
  df_hi <- df_estimate %>%
    left_join(df_hessian_temp, by = c('y1', 'y2', 'y3')) %>%
    mutate(
  ...
  hessian_matrix <- matrix(c(
    sum(df_hi$joint_d2_theta0_1_theta0_1),
    sum(df_hi$joint_d2_theta0_1_theta1_1),
    sum(df_hi$joint_d2_theta0_1_p_1), 
    sum(df_hi$joint_d2_theta0_1_theta0_2),
    sum(df_hi$joint_d2_theta0_1_theta1_2),
    sum(df_hi$joint_d2_theta0_1_pi),
    
    sum(df_hi$joint_d2_theta0_1_theta1_1),  
    sum(df_hi$joint_d2_theta1_1_theta1_1),
    sum(df_hi$joint_d2_theta1_1_p_1), 
    sum(df_hi$joint_d2_theta1_1_theta0_2),
    sum(df_hi$joint_d2_theta1_1_theta1_2),
    sum(df_hi$joint_d2_theta1_1_pi),  
    
    sum(df_hi$joint_d2_theta0_1_p_1), 
    sum(df_hi$joint_d2_theta1_1_p_1), 
    sum(df_hi$joint_d2_p_1_p_1),
    sum(df_hi$joint_d2_theta0_2_p_1), 
    sum(df_hi$joint_d2_theta1_2_p_1),
    sum(df_hi$joint_d2_pi_p_1),
    
    sum(df_hi$joint_d2_theta0_1_theta0_2),
    sum(df_hi$joint_d2_theta1_1_theta0_2),
    sum(df_hi$joint_d2_theta0_2_p_1),
    sum(df_hi$joint_d2_theta0_2_theta0_2),
    sum(df_hi$joint_d2_theta0_2_theta1_2),
    sum(df_hi$joint_d2_theta0_2_pi),
    
    sum(df_hi$joint_d2_theta0_1_theta1_2),
    sum(df_hi$joint_d2_theta1_1_theta1_2),
    sum(df_hi$joint_d2_theta1_2_p_1),
    sum(df_hi$joint_d2_theta0_2_theta1_2),
    sum(df_hi$joint_d2_theta1_2_theta1_2),
    sum(df_hi$joint_d2_theta1_2_pi),
