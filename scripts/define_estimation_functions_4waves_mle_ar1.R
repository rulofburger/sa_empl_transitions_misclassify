...
# FUNCTIONS FOR AR(1) ML ESTIMATOR OVER 4 WAVES WITH MISCLASSIFICATION ERROR ====

calc_lli_4waves_ar1 <- function(param_transformed) {
...
calc_lli_derivatives_4waves_ar1 <- function(param_transformed, df_x) {
  ...
  df_probs_temp <- df_template %>% 
    mutate(
      ...
      joint_d_theta_1 = 
        d1_star_theta_1*p1*p2_star*p2*p3_star*p3*p4_star*p4 + 
        p1_star*p1*d2_star_theta_1*p2*p3_star*p3*p4_star*p4 + 
        p1_star*p1*p2_star*p2*d3_star_theta_1*p3*p4_star*p4 + 
        p1_star*p1*p2_star*p2*p3_star*p3*d4_star_theta_1*p4,
      joint_d_theta_2 = 
        d1_star_theta_2*p1*p2_star*p2*p3_star*p3*p4_star*p4 + 
        p1_star*p1*d2_star_theta_2*p2*p3_star*p3*p4_star*p4 + 
        p1_star*p1*p2_star*p2*d3_star_theta_2*p3*p4_star*p4 +
        p1_star*p1*p2_star*p2*p3_star*p3*d4_star_theta_2*p4,
      joint_d_pi = 
        p1_star*d1_pi*p2_star*p2*p3_star*p3*p4_star*p4 + 
        p1_star*p1*p2_star*d2_pi*p3_star*p3*p4_star*p4 + 
        p1_star*p1*p2_star*p2*p3_star*d3_pi*p4_star*p4 + 
        p1_star*p1*p2_star*p2*p3_star*p3*p4_star*d4_pi
    ) 
...
calc_mle_4waves_ar1 <- function(param_transformed) {
  ll <- sum(calc_lli_4waves_ar1(param_transformed))
  return(ll)
}

calc_mle_derivatives_4waves_ar1 <- function(param_transformed) {
  lg <- colSums(calc_lli_derivatives_4waves_ar1(param_transformed))
  return(lg)
}


# FUNCTIONS FOR AR(1) ML ESTIMATOR OVER 4 WAVES WITH NO MISCLASSIFICATION ERROR ====

calc_lli_4waves_ar1_pi0 <- function(param_transformed) {
...
calc_lli_derivatives_4waves_ar1_pi0 <- function(param_transformed, df_x) {
...
calc_mle_4waves_ar1_pi0 <- function(param_transformed) {
  ll <- sum(calc_lli_4waves_ar1_pi0(param_transformed))
  return(ll)
}

calc_mle_derivatives_4waves_ar1_pi0 <- function(param_transformed) {
  lg <- colSums(calc_lli_derivatives_4waves_ar1_pi0(param_transformed))
  return(lg)
}
