...
# FUNCTIONS FOR AR(2) ML ESTIMATOR OVER 4 WAVES WITH MISCLASSIFICATION ERROR ====

calc_lli_4waves <- function(param_transformed) {
...
calc_lli_derivatives_4waves <- function(param_transformed, df_x) {
...
calc_mle_4waves <- function(param_transformed) {
  ll <- sum(calc_lli_4waves(param_transformed))
  return(ll)
}

calc_mle_derivatives_4waves <- function(param_transformed) {
  lg <- colSums(calc_lli_derivatives_4waves(param_transformed))
  return(lg)
}


# FUNCTIONS FOR AR(2) ML ESTIMATOR OVER 4 WAVES WITH NO MISCLASSIFICATION ERROR ====

calc_lli_4waves_pi0 <- function(param_transformed) {
...
calc_lli_derivatives_4waves_pi0 <- function(param_transformed, df_x) {
...
calc_mle_4waves_pi0 <- function(param_transformed) {
  ll <- sum(calc_lli_4waves_pi0(param_transformed))
  return(ll)
}

calc_mle_derivatives_4waves_pi0 <- function(param_transformed) {
  lg <- colSums(calc_lli_derivatives_4waves_pi0(param_transformed))
  return(lg)
}
