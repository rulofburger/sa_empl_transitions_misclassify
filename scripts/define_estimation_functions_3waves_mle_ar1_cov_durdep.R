...
calc_df_probs_cov_durdep <- function(df_cov, param_transformed) {
...
calc_lli_3waves_ar1_cov_durdep <- function(df_template, data, param_transformed) {
  ...
  df_probs <- calc_df_probs_cov_durdep(df_cov            = df_cov, 
...
calc_lli_derivatives_3waves_ar1_cov_durdep <- function(param_transformed, df_x) {
...
calc_mle_3waves_ar1_cov_durdep <- function(param_transformed) {
  ll <- sum(calc_lli_3waves_ar1_cov_durdep(param_transformed))
  return(ll)
}

calc_mle_derivatives_3waves_ar1_cov_durdep <- function(param_transformed) {
  lg <- colSums(calc_lli_derivatives_3waves_ar1_cov_durdep(param_transformed))
  return(lg)
}
