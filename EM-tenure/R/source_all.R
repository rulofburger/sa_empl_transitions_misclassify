...
source(file.path(.em_tenure_r, "tenure_local_gross_eps.R"), local = FALSE)
source(file.path(.em_tenure_r, "job_change_eps.R"),    local = FALSE)
source(file.path(.em_tenure_r, "tenure_monthly_eps.R"), local = FALSE)
source(file.path(.em_tenure_r, "estep_eps.R"),         local = FALSE)
source(file.path(.em_tenure_r, "four_wave_eps.R"),     local = FALSE)
source(file.path(.em_tenure_r, "timegap_clock_joint.R"), local = FALSE)
source(file.path(.em_tenure_r, "piecewise_risk_exact.R"), local = FALSE)
source(file.path(.em_tenure_r, "four_wave_fast.R"),    local = FALSE)
source(file.path(.em_tenure_r, "four_wave_ar2.R"), local = FALSE)
source(file.path(.em_tenure_r, "simulate_four_wave_ar2.R"), local = FALSE)
source(file.path(.em_tenure_r, "fit_four_wave_ar2.R"), local = FALSE)
...
source(file.path(.em_tenure_r, "data_prep_eps.R"),     local = FALSE)
source(file.path(.em_tenure_r, "diagnostics_eps.R"),  local = FALSE)
source(file.path(.em_tenure_r, "duration_hazard_eps.R"), local = FALSE)
source(file.path(.em_tenure_r, "piecewise_hazard_eps.R"), local = FALSE)
